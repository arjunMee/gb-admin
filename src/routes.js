...
const ManageAllUser = React.lazy(() => import('./views/Dashboard/ManageUsers/AllUsers'))
const ManageVerified = React.lazy(() => import('./views/Dashboard/ManageUsers/VerifiedUsers'))
const ManageSuspended = React.lazy(() => import('./views/Dashboard/ManageUsers/SuspendedUsers'))
const ManageBanned = React.lazy(() => import('./views/Dashboard/ManageUsers/BannedUsers'))
const ManageProfile = React.lazy(() => import('./views/Dashboard/ManageUsers/UserProfileDetails'))
const ManageReport = React.lazy(() => import('./views/Dashboard/ManageUsers/UserReportDetails'))
const ManageReportAllList = React.lazy(() => import('./views/Dashboard/ManageReport/AllReport'))
// Tournament
const TournamentHome = React.lazy(() => import('./views/Tournament/Home/Dashboard'))
const TournamentEvenAll = React.lazy(() => import('./views/Tournament/Events/AllEvent'))
const TournamentEvenSpan = React.lazy(() => import('./views/Tournament/Events/spanEvent'))
const TournamentEvenReview = React.lazy(() => import('./views/Tournament/Events/ReviewEvent'))
const TournamentEvenCancel = React.lazy(() => import('./views/Tournament/Events/CancelledEvent'))
const TicketAll = React.lazy(() => import('./views/Tournament/Ticket/AllTicket'))
const TicketCancel = React.lazy(() => import('./views/Tournament/Ticket/CancelledTicket'))
const TournamentRevenue = React.lazy(() => import('./views/Tournament/Revenue'))
const TournamentAds = React.lazy(() => import('./views/Tournament/Ads'))
const TournamentBannerAds = React.lazy(() => import('./views/Tournament/Ads/BannedAds'))
const TournamentPayments = React.lazy(() => import('./views/Tournament/Payment'))
const TournamentAnalytics = React.lazy(() => import('./views/Tournament/Analytics'))
...
const GeneralAdminEmployeeList = React.lazy(() => import('./views/AdminSection/EmployeeList'))
const GeneralAdminEmployeeListDetails = React.lazy(() =>
  import('./views/AdminSection/EmployeeList/EmployeeDetails'),
)

const routes = [
  { path: '/dashboard/home', name: 'Dashboard', exact: true, component: Dashboard },
  { path: '/dashboard/home/statistics', name: 'Statistics', component: Statistics },
  { path: '/dashboard/home/users/all', name: 'ManageUser', component: ManageAllUser },
  { path: '/dashboard/home/users/verified', name: 'ManageUser', component: ManageVerified },
  { path: '/dashboard/home/users/suspended', name: 'ManageUser', component: ManageSuspended },
  { path: '/dashboard/home/users/banned', name: 'ManageUser', component: ManageBanned },
  { path: '/dashboard/home/users/profile/:userId', name: 'ManageUser', component: ManageProfile },
  { path: '/dashboard/home/users/report/:userId', name: 'ManageUser', component: ManageReport },
  { path: '/dashboard/home/reports/all', name: 'ManageReport', component: ManageReportAllList },
  { path: '/tournament/home', name: 'ManageReport', exact: true, component: TournamentHome },
  {
    path: '/tournament/event/allEvent',
    name: 'ManageReport',
    exact: true,
    component: TournamentEvenAll,
  },
  {
    path: '/tournament/event/reviewEvent',
    name: 'ManageReport',
    exact: true,
    component: TournamentEvenSpan,
  },
  {
    path: '/tournament/event/cancelEvent',
    name: 'ManageReport',
    exact: true,
    component: TournamentEvenReview,
  },
  {
    path: '/tournament/event/spamEvent',
    name: 'ManageReport',
    exact: true,
    component: TournamentEvenCancel,
  },
  {
    path: '/tournament/ticket/allTicket',
    name: 'ManageReport',
    exact: true,
    component: TicketAll,
  },
  {
    path: '/tournament/ticket/cancelTicket',
    name: 'ManageReport',
    exact: true,
    component: TicketCancel,
  },
  {
    path: '/tournament/revenue',
    name: 'ManageReport',
    exact: true,
    component: TournamentRevenue,
  },
  {
    path: '/tournament/ads',
    name: 'ManageReport',
    exact: true,
    component: TournamentAds,
  },
  {
    path: '/tournament/ads/banner',
    name: 'ManageReport',
    exact: true,
    component: TournamentBannerAds,
  },
  {
    path: '/tournament/payments',
    name: 'ManageReport',
    exact: true,
    component: TournamentPayments,
  },
  {
  ...
  {
    path: '/tournament/support',
    name: 'ManageReport',
    exact: true,
    component: TournamentSupport,
  },
  {
    path: '/generalAdmin/home',
    name: 'ManageReport',
    exact: true,
...

  {
    ...
    name: 'ManageReport',
    exact: true,
    component: GeneralAdminSetting,
  },
  {
    path: '/generalAdmin/Setting/addUser',
    name: 'ManageReport',
    exact: true,
    component: GeneralAdminSettingAddUser,
  },
  {
    path: '/generalAdmin/employee-list',
    name: 'Employee List',
    exact: true,
    component: GeneralAdminEmployeeList,
  },
  {
    path: '/generalAdmin/employee-list/:employeeId',
    name: 'Employee List',
    exact: true,
    component: GeneralAdminEmployeeListDetails,
  },

  // { path: '/demo-dashboard', name: 'Demo Dashboard', component: OldDashboard },
